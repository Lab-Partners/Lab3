...
public class Hand {
	...
	public void jokerEval() {
		...
		if (Joker)
		{
			...
			for(int i = 0; i < 52 ; i++)
			{
				...
				//FROM HERE WE WANT TO SCORE JOKERHAND FOR EACH CARD -> ADD SCORE TO JOKERSCORES -> SORT AND RETRIEVE HIGHEST SCORE
			}
		}
	}
	...
	public void EvalHand() {
		...
		// Five of a Kind
		// WE SAID IF JOKER IS PRESENT AND THE FIRST AND FIFTH CARD ARE EQUAL, FIVE OF A KIND IS SCORED
		else if (Joker == true
